...
(cl:in-package serial_port_ros-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <serial_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'serial_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serial_port_ros-msg:<serial_data> is deprecated: use serial_port_ros-msg:serial_data instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <serial_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_port_ros-msg:data-val is deprecated.  Use serial_port_ros-msg:data instead.")
  (data m))
